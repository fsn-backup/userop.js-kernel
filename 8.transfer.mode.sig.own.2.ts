...
async function main() {
  ...
  const wallet1AA = "0x4b60e99f6F5D98FFbd186940d6aCB7815a80dd3E"

  const sessionKeyAddr = selfAddress
  const executor = selfAddress

  const provider2Addr = "0x93356ED2567a40870B542820EA97f06C0DfFd50E"
  const provider2Priv = "51edb41ac23fc60b4ae8f595cba7ac0bbce8daa131bb1d815d6d68b8a05f76af"
  ...
  const wallet2 = new ethers.Wallet(provider2Priv, provider);
  ...
  const call = {
    to: wallet1AA,
    value: 0,
    data: KernelContract.interface.encodeFunctionData("execute", ["0x88790E1dCeb0A4Da48C7b05ba7393c137Ead3afe", 0, "0x", 0]),
  };
  ...
  const sessionKeySigData = "0x94c412bfbc5de81e13c28e6a14653be2404912b5cbe645545fc3a0b2797b0219315c6a5b29f9ac3aa4547ce39ff2772c3b1c8029c5c1c326b9f83e35f48d14711c"
