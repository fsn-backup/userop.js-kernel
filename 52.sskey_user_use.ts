...
async function main() {
  ...
  const kernelFactory = "0xd6A97E86492d986956D0D981f1896A5dC55F8857";
  const kernelImpl = "0x938601C97616Ee2EB90460aa3Da5f376F53bf146";
  const ECDSAValidator = "0x4D8F5D0954C25e617B326F369aFB9B1be690C20C";
  const SessionKeyExecValidator = "0x96715C513E39B3E683D91597A8E1FbD26a6960a3";
  const SessionKeyOwnedValidator = "0x91B729e0Ffc016b7A1cE03666aCdF6c2d7856AaE";
...
// ])
  ...
  console.log(recoveredAddress2, recoveredAddress2 == sessionKeyAddr)
