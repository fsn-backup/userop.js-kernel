...
async function main() {
  ...
  // console.log("---")
  // console.log("sessionKeyAddr:", sessionKeyAddr)
  // console.log("merkleTree:", merkleTree.getHexRoot())
  // console.log("validAfter:", sessionKeyData.validAfter)
  // console.log("validUntil:", sessionKeyData.validUntil)
  // console.log("---")
  ...
  console.log('------')
  console.log('validatorMode: ', validatorMode);
  console.log('validUntil: ', validUntil);
  console.log('validAfter: ', 1);
  console.log('sessionKeyValidator: ', SessionKeyExecValidator);
  console.log('serverAddr: ', sessionKeyExecutor);
  console.log('enableDataLength: ', enableDataLength);
  console.log('enableData: ', enableData);
  console.log('enableSigLength: ', enableSigLength);
  console.log('enableSignature: ', enableSignature);
