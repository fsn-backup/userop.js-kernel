...
async function main() {
  ...
  const kernelFactory = "0x8Fe6E479d678c247c5134C931F3AE3b3f3465216";
  ...
  const SessionKeyOwnedValidator = "0x5778549Bf035A79484294b60a3cC3ddFef3b1aEd"
  ...
  //   to: userAA1Addr,
  //   value: 0,
  //   data: KernelContract.interface.encodeFunctionData("execute", [receiveAddr, 1, "0x", 0]),
  // };
